from device_controller_api.controller.gpio.pigpio_gpio_controller import PigpioGpioController, Pulse, PowerLevel, \
    PinMode
...
class ErloRemoteSocket(RemoteSocket):
    ...
    def __init__(self, gpio_controller: PigpioGpioController, transmitter_pin: int, group_code: str, device_code: str,
                 repeats: int):
